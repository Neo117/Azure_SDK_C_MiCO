...
#else
#ifdef JLINK_RTT_LOG
#define LogInfo(FORMAT, ...) SEGGER_RTT_printf(0,"LogInfo: "FORMAT"\r\n", ##__VA_ARGS__)//do{LOG(AZ_LOG_INFO, LOG_LINE, FORMAT, ##__VA_ARGS__); }while((void)0,0)
#else
#define LogInfo(FORMAT, ...) do{LOG(AZ_LOG_INFO, LOG_LINE, FORMAT, ##__VA_ARGS__); }while((void)0,0)
#endif
#endif
...
#else
#ifdef JLINK_RTT_LOG
//#define LogError(FORMAT, ...) SEGGER_RTT_printf(0,"LogErr: "FORMAT"\r\n", ##__VA_ARGS__)//do{ LOG(AZ_LOG_ERROR, LOG_LINE, FORMAT, ##__VA_ARGS__); }while((void)0,0)
#else
#define LogError(FORMAT, ...) do{ LOG(AZ_LOG_ERROR, LOG_LINE, FORMAT, ##__VA_ARGS__); }while((void)0,0)
#endif
#endif
